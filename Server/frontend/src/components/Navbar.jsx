...
export function StatusBadge({ status }) {
  const style =
    STATUS_STYLES[status] || "bg-zinc-800/60 text-zinc-400 border-zinc-600/40";
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
              ...
              {navItems.map(({ href, label, icon: Icon }) => {
                ...
                return (
                  <Link
                    ...
                    onMouseEnter={(e) => {
                      if (!active) e.currentTarget.style.color = "#f9f9f9";
                    }}
                    onMouseLeave={(e) => {
                      if (!active) e.currentTarget.style.color = "#9c9c9d";
                    }}
                  >
          ...
          <DropdownMenu>
            ...
            >
              <div
                className="h-6 w-6 rounded-md flex items-center justify-center text-xs font-semibold text-white"
                style={{
            ...
            <DropdownMenuContent
              ...
              style={{
                ...
                border: "1px solid rgba(255,255,255,0.08)",
                boxShadow:
                  "rgba(0,0,0,0.5) 0px 0px 0px 2px, rgba(255,255,255,0.19) 0px 0px 14px, rgba(0,0,0,0.5) 0px 16px 48px",
              }}
            >
